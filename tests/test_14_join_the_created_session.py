...
def test_join_session_button_from_created_session(driver):
    ...
    assert element_clicked_by_xpath(driver,'//android.widget.Button[@resource-id="com.supportgenie.argenie:id/join_meeting_btn"]'), "Failed to Click the Join Session Button"
